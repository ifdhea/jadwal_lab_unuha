 ...
 * @route '/user/two-factor-authentication'
 */
enable.form = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/user/confirmed-two-factor-authentication'
 */
confirm.form = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/user/two-factor-authentication'
 */
disable.form = (options?: RouteQueryOptions): RouteFormDefinition<'delete'> => ({
 ...
 * @route '/user/two-factor-recovery-codes'
 */
regenerateRecoveryCodes.form = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
