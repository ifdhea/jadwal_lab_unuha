...
export default function Edit({ jadwalMaster, semester, kelasMatkul, dosen, laboratorium, slotWaktu, hari, breadcrumbs }: Props) {
    const { data, setData, put, errors, processing } = useForm({
        semester_id: String(jadwalMaster.semester_id),
    ...
    const submit = (e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        put(`/jadwal-master/${jadwalMaster.id}`);
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Edit Jadwal Master" />

            <Card>
                <CardHeader>
                    <CardTitle>Edit Jadwal Master</CardTitle>
                    <CardDescription>
                        Perbarui data mentah jadwal untuk satu semester.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <form onSubmit={submit} className="space-y-6">
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                            ...
                            <div className="flex flex-col gap-1.5">
                                ...
                                <Select value={data.semester_id} onValueChange={(value) => setData('semester_id', value)} required>
                            ...
                            <div className="flex flex-col gap-1.5 lg:col-span-2">
                                ...
                                <Select value={data.kelas_mata_kuliah_id} onValueChange={(value) => setData('kelas_mata_kuliah_id', value)} required>
                            ...
                            <div className="flex flex-col gap-1.5">
                                ...
                                <Select value={data.dosen_id} onValueChange={(value) => setData('dosen_id', value)} required>
                            ...
                            <div className="flex flex-col gap-1.5">
                                ...
                                <Select value={data.laboratorium_id} onValueChange={(value) => setData('laboratorium_id', value)} required>
                            ...
                            <div className="flex flex-col gap-1.5">
                                ...
                                <Select value={data.hari} onValueChange={(value) => setData('hari', value)} required>
                            ...
                            <div className="flex flex-col gap-1.5">
                                ...
                                <Select value={data.slot_waktu_mulai_id} onValueChange={(value) => setData('slot_waktu_mulai_id', value)} required>
                            ...
                            <div className="flex flex-col gap-1.5">
                                ...
                                <Select value={data.slot_waktu_selesai_id} onValueChange={(value) => setData('slot_waktu_selesai_id', value)} required>
