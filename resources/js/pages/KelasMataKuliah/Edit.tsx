...
export default function Edit({
    ...
    const { data, setData, put, errors, processing } = useForm({
        kelas_id: String(kelasMataKuliah.kelas_id),
        mata_kuliah_id: String(kelasMataKuliah.mata_kuliah_id),
        semester_id: String(kelasMataKuliah.semester_id),
    });

    const submit = (e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        put(`/kelas-matkul/${kelasMataKuliah.id}`);
    };
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Perbarui penugasan mata kuliah ke kelas pada semester tertentu.
                    </CardDescription>
                </CardHeader>
                <CardContent>
