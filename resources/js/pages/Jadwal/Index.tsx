...
export default function Index({
    ...
    const handleExport = () => {
        ...
        window.location.href = `/jadwal/export?${params.toString()}`;

        // Reset loading state setelah delay
        setTimeout(() => {
            setIsExporting(false);
        }, 3000); // Increased to 3 seconds for larger export
    };
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Button
                        ...
                        disabled={isExporting || !selectedSemesterId}
                                                            ...
                                                            <table className="border-collapse text-sm">
                                                                <thead>
                                                                    <tr className="bg-muted/50">
                                                                        <th className="sticky left-0 z-20 w-24 border-r-2 border-r-gray-300 bg-muted p-1 font-semibold shadow-md min-w-[140px]">
                                                                            Jam
                                                                        </th>
                                                                        {hari.map((h) => {
                                                                        ...
                                                                        return slots.map(
                                                                            (slot, slotIdx) => {
                                                                                ...
                                                                                return (
                                                                                    ...
                                                                                    >
                                                                                        <td className={`sticky left-0 z-10 border p-2 text-center font-mono text-xs font-semibold ${isBreakTime ? 'bg-muted h-16' : 'bg-background h-24'
                                                                                            }`}>
