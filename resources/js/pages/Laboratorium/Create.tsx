...
export default function Create({ kampus, breadcrumbs }: Props) {
            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
                <div className="space-y-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold">Tambah Laboratorium</h1>
                            <p className="text-muted-foreground">
                                Tambahkan laboratorium komputer baru
                            </p>
                        </div>
                    </div>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Isi formulir di bawah untuk menambahkan laboratorium baru
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
