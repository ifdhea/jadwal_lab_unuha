...
export default function Edit({ kelas, programStudi, kampus, tahunAjaran, breadcrumbs }: Props) {
    const { data, setData, put, errors, processing } = useForm({
        program_studi_id: String(kelas.program_studi_id),
        kampus_id: String(kelas.kampus_id),
        tahun_ajaran_id: String(kelas.tahun_ajaran_id),
        tingkat_semester: kelas.tingkat_semester,
        kode: kelas.kode,
        nama: kelas.nama,
        kapasitas: kelas.kapasitas,
        is_aktif: kelas.is_aktif,
    });
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Edit Kelas: ${kelas.nama}`} />

            <Card>
                <CardHeader>
                    <CardTitle>Edit Kelas</CardTitle>
                    <CardDescription>Perbarui data kelas yang sudah ada di sistem.</CardDescription>
                </CardHeader>
                <CardContent>
