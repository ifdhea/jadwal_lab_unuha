                                                                                                    ...
                                                                                                    <tr className="bg-muted/50">
                                                                                                        ...
                                                                                                        {hari.map((h) => {
                                                                                                            ...
                                                                                                            return (
                                                                                                                <th
                                                                                                                    key={h.id}
                                                                                                                    className={`border p-2 font-semibold min-w-[160px] md:min-w-0 ${
                                                                                                                        isTodayCell
                                                                                                            ...
                                                                                                            return (
                                                                                                                ...
                                                                                                                >
                                                                                                                    <td className={`sticky left-0 z-10 border p-2 text-center font-mono text-xs font-semibold ${
                                                                                                                        isBreakTime ? 'bg-muted h-16' : 'bg-background h-24'
                                                                                                                    }`}>
                                                                                                                                                ...
                                                                                                                                                >
                                                                                                                                                    ...
                                                                                                                                                    <div className={`mt-1.5 flex items-center justify-between border-t pt-1.5 ${colorScheme.border.replace('border-', 'border-opacity-20 border-')}`}>
                                                                                                                                                        ...
                                                                                                                                                        <div className="flex gap-1">
                                                                                                                                                            ...
                                                                                                                                                            {/* Badge Jadwal Saya */}
                                                                                                                                                            {cell.is_my_schedule && !cell.is_past && !cell.is_active && cell.status !== 'booking' && (
